...
pacman -S --noconfirm xorg-server xorg-xinit xorg-xkill xorg-xsetroot xorg-xbacklight xorg-xprop \
     ...
     networkmanager arc-gtk-theme rsync qutebrowser dash \
...
rm -r tmpdotfiles
# dwm: Window Manager
git clone --depth=1 https://github.com/r4vanan/dwm.git ~/.local/src/dwm
sudo make -C ~/.local/src/dwm install

# st: Terminal
git clone --depth=1 https://github.com/r4vanan/st.git ~/.local/src/st
...
# remaping capslock and escape keys
